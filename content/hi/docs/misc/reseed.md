...
- **Reseed टूल्स**: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools) से आधिकारिक reseed-tools
...
I2P परियोजना द्वारा देखरेख किया जाने वाला प्रामाणिक कार्यान्वयन। रेपोजिटरी: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)
...
PurpleI2P परियोजना द्वारा वैकल्पिक कार्यान्वयन: [PurpleI2P/pyseeder](https://github.com/PurpleI2P/pyseeder)
...
**प्रलेखन**: [Notes on I2P reseed over Cloudflare](https://homepage.np-tokumei.net/post/notes-i2p-reseed-over-cloudflare/)
...
**शोध प्रलेखन**: [Censorship-resistant reseeding notes](https://homepage.np-tokumei.net/post/notes-censorship-resistant-i2p-reseeding/)
...
[checki2p.com/reseed](https://checki2p.com/reseed) पर उपलब्ध सेवा सभी पंजीकृत I2P reseed (I2P में प्रारंभिक बूटस्ट्रैप प्रक्रिया) सर्वरों पर हर 4 घंटे में स्वचालित जाँच करती है। यह प्रदान करती है:
...
- **Reseed टूल्स रिपॉज़िटरी**: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)
- **Reseed टूल्स दस्तावेज़ीकरण**: [eyedeekay.github.io/reseed-tools](https://eyedeekay.github.io/reseed-tools/)
...
- **Python WSGI reseeder (रीसीड सर्वर)**: [torbjo/i2p-reseeder](https://github.com/torbjo/i2p-reseeder)

...
<th style="border: 1px solid var(--color-border); padding: 8px;">प्रकार</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">कोड</th>
</tr>
<tr>
...
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">प्रकार</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">प्रकार कोड</th>
...
</table>नोट: Type codes केवल आंतरिक उपयोग के लिए हैं। Router type 4 ही रहेंगे, और समर्थन router addresses में दर्शाया जाएगा।
...
</table>नोट: Type कोड केवल आंतरिक उपयोग के लिए हैं। Router Type 4 ही रहेंगे, और समर्थन router पतों में दर्शाया जाएगा।
...
<table style="border: 1px solid var(--color-border); border-collapse: collapse;">
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">श्रेणी</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">उतना सुरक्षित जितना</th>
</tr>
<tr>
...
<table style="border: 1px solid var(--color-border); border-collapse: collapse;">
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">एल्गोरिदम</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">सुरक्षा श्रेणी</th>
</tr>
<tr>

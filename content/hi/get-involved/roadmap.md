...
**रिलीज़ चक्र:** मुख्य रिलीज़ के लिए लगभग हर 13 सप्ताह

**समर्थन नीति:** - **वर्तमान रिलीज़**: अपडेट और सिक्यूरिटी पैच के साथ पूर्ण समर्थन - **पिछली रिलीज़**: केवल सिक्यूरिटी अपडेट - **पुरानी रिलीज़**: अब समर्थित नहीं (अपग्रेड की सिफारिश)

**संस्करण संख्यांकन:** - 0.9.x श्रृंखला से शुरुआत (0.9.66 तक) - 1.x श्रृंखला में संक्रमण (1.5.0 से 1.9.0 तक) - अब 2.x श्रृंखला में (2.0.0+)

---

## विकास संसाधन

- **सोर्स कोड**: [i2pgit.org](https://i2pgit.org)
- **इश्यू ट्रैकर**: i2pgit.org या github issues
- **मासिक मीटिंग**: वर्तमान में सक्रिय नहीं
...
I2P के भविष्य में योगदान देना चाहते हैं? [Get Involved](/en/get-involved) पेज देखें और जानें कि आप development, testing, documentation, और अन्य कार्यों में कैसे मदद कर सकते हैं!

नवीनतम समाचार और विस्तृत रिलीज़ जानकारी के लिए, [I2P Blog](/en/blog) पर जाएं।

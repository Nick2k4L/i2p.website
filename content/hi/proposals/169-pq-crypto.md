...
| MLDSA65ph | 19 |
| MLDSA87ph | 20 |
X.509 प्रमाणपत्र और अन्य DER एन्कोडिंग [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में परिभाषित संरचनाओं और OIDs का उपयोग करेंगे।
...
संयुक्त संकर हस्ताक्षर सार्वजनिक कुंजियाँ PQ कुंजी के बाद Ed25519 कुंजी के रूप में होती हैं, जैसा कि [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में दिया गया है। एन्कोडिंग और बाइट क्रम [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) में परिभाषित हैं।
...
संयुक्त संकर हस्ताक्षर निजी कुंजियाँ PQ कुंजी के बाद Ed25519 कुंजी होती हैं, जैसा कि [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में दिया गया है। एन्कोडिंग और बाइट ऑर्डर को [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) में परिभाषित किया गया है।

हस्ताक्षर करने वाली निजी कुंजियाँ कभी भी तार पर नहीं भेजी जाती हैं। अनुप्रयोग विस्तारित बहु-KB निजी कुंजी के बजाय [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में अनुशंसित तरीके से 32-बिट बीज को संग्रहीत करना चुन सकते हैं। यह लागू करने पर निर्भर करता है।
...
संयुक्त संकर हस्ताक्षर PQ हस्ताक्षर के बाद Ed25519 हस्ताक्षर होते हैं, जैसा कि [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में दिखाया गया है। संकर हस्ताक्षरों को दोनों हस्ताक्षरों को सत्यापित करके और यदि कोई भी एक विफल हो जाता है तो विफल घोषित करके सत्यापित किया जाता है। एन्कोडिंग और बाइट ऑर्डर [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) में परिभाषित हैं।
...
हाइब्रिड या पीक्यू हस्ताक्षर प्रकार वाले गंतव्यों के लिए, एन्क्रिप्शन प्रकार के लिए NONE (प्रकार 255) का उपयोग करें, लेकिन कोई क्रिप्टो कुंजी नहीं होती है, और 384-बाइट का पूरा मुख्य भाग हस्ताक्षर कुंजी के लिए होता है।
...
संयुक्त हाइब्रिड हस्ताक्षर एल्गोरिदम के लिए एक नया विनिर्देश निम्नानुसार जोड़ें: संयुक्त हाइब्रिड हस्ताक्षर [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में परिभाषित के अनुसार हैं। हालांकि, जैसा कि आम तौर पर, I2P के भीतर सार्वजनिक कुंजियां और हस्ताक्षर DER एन्कोडिंग ओमिट करते हैं।

संयुक्त हस्ताक्षर हमेशा प्रीहैशिंग का उपयोग करते हैं, ताकि संभावित रूप से बड़े संदेशों को दो बार संसाधित करने की आवश्यकता न हो। यह MLDSA एल्गोरिथ्म के बाहर है, हम मानक MLDSA का उपयोग करते हैं, HashML-DSA नहीं।
...
हस्ताक्षर एल्गोरिथ्म के समान। यदि कोई भी हस्ताक्षर विफल होता है तो विफल हो जाए।
...
[COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) MLDSA87 + Ed25519 संयोजन को परिभाषित नहीं करता है, शायद सुरक्षा ताकत में अंतर के कारण। यह SHAKE256/64 को प्रीहैश फ़ंक्शन के रूप में उपयोग करते हुए MLDSA87 + Ed448 को परिभाषित करता है। यह संयोजन वर्तमान में इस प्रस्ताव में शामिल नहीं है, क्योंकि हम वर्तमान में Ed448 का समर्थन नहीं करते हैं।
...
हाइब्रिड फॉरवर्ड सीक्रेसी (hfs) के लिए XK और IK में निम्नलिखित संशोधन खंड 5 में [Noise HFS spec](https://github.com/noiseprotocol/noise_hfs_spec/blob/master/output/noise_hfs.pdf) में निर्दिष्ट के अनुसार हैं:
...
```
ई1 पैटर्न को निम्नानुसार परिभाषित किया गया है, जैसा कि [Noise HFS spec](https://github.com/noiseprotocol/noise_hfs_spec/blob/master/output/noise_hfs.pdf) के अनुभाग 4 में निर्दिष्ट किया गया है:
...
For Alice:
  ...
  MixHash(ciphertext)
```
ekem1 पैटर्न को निम्नानुसार परिभाषित किया गया है, जैसा कि [Noise HFS spec](https://github.com/noiseprotocol/noise_hfs_spec/blob/master/output/noise_hfs.pdf) धारा 4 में निर्दिष्ट किया गया है:
...
हाइब्रिड हैंडशेक को [नॉइज़ एचएफएस स्पेक](https://github.com/noiseprotocol/noise_hfs_spec/blob/master/output/noise_hfs.pdf) में परिभाषित किया गया है। एलिस से बॉब की ओर पहला संदेश, संदेश पेलोड से पहले e1, एनकैप्सूलेशन कुंजी, शामिल करता है। इसे एक अतिरिक्त स्थिर कुंजी के रूप में माना जाता है; इस पर EncryptAndHash() को कॉल करें (एलिस के रूप में) या DecryptAndHash() (बॉब के रूप में)। फिर संदेश पेलोड को सामान्य रूप से प्रोसेस करें।
...
हम [FIPS 203](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.203.pdf) में परिभाषित क्रिप्टोग्राफिक निर्माण खंडों के अनुरूप निम्नलिखित फ़ंक्शन परिभाषित करते हैं।
...
ध्यान दें कि encap_key और ciphertext दोनों को नॉइज़ हैंडशेक संदेशों 1 और 2 में ChaCha/Poly ब्लॉक्स के अंदर एन्क्रिप्ट किया गया है। इन्हें हैंडशेक प्रक्रिया के भाग के रूप में डिक्रिप्ट किया जाएगा।
...
आईके के लिए: 'es' संदेश पैटर्न के बाद और 's' संदेश पैटर्न से पहले, निम्नलिखित जोड़ें:
...
आईके के लिए: 'ee' संदेश पैटर्न के बाद और 'se' संदेश पैटर्न से पहले जोड़ें:
...
ECIES-Ratchet विशिष्टता को निम्नानुसार अद्यतन करें [/docs/specs/ecies/](/docs/specs/ecies/):
...
परिवर्तन: वर्तमान रैचेट में पहले ChaCha खंड के लिए खाली पेलोड होता है, और दूसरे खंड में पेलोड होता है। ML-KEM के साथ, अब तीन खंड हैं। पहला खंड एन्क्रिप्टेड PQ साइफरटेक्स्ट युक्त होता है। दूसरे खंड में पेलोड खाली होता है। तीसरा खंड पेलोड युक्त होता है।
...
अधिकतम आकार: अपने राउटरइन्फो में प्रकाशित बॉब के एमटीयू का उपयोग करें, या यदि राउटरइन्फो में नहीं है तो डिफ़ॉल्ट 1500 का उपयोग करें। यदि प्रकाशित एमटीयू बहुत कम है तो MLKEM768_X25519 का उपयोग न करें।
...
अधिकतम आकार: एलिस के पास अभी तक बॉब का राउटरइन्फो नहीं है और उसे उसके प्रकाशित MTU की जानकारी नहीं है। इस संदेश के लिए निम्नलिखित अस्थायी MTU का उपयोग करें। MLKEM512_X25519 के लिए, 1280 या प्राप्त सत्र अनुरोध आकार में से अधिकतम को MTU के रूप में उपयोग करें। MLKEM768_X25519 के लिए, (IPv4 के लिए 1318 या IPv6 के लिए 1338) या प्राप्त सत्र अनुरोध आकार में से अधिकतम को MTU के रूप में उपयोग करें। सत्र अनुरोध की तुलना में सत्र निर्मित का ओवरहेड कम होता है, क्योंकि MLKEM साइफरटेक्स्ट, MLKEM सार्वजनिक कुंजी की तुलना में छोटी होती है। इससे सत्र निर्मित में पैडिंग के आकार की एक श्रृंखला की अनुमति मिलती है, भले ही सत्र अनुरोध में थोड़ी या बिल्कुल पैडिंग न हो।
...
निम्नलिखित ब्लॉकों में संस्करण (version) फ़ील्ड शामिल हैं। ये संस्करण 2 पर बने रहेंगे (गैर-PQ बॉब के साथ संगतता के लिए), और PQ के लिए संस्करण 3/4 में परिवर्तित नहीं होंगे।
...
गैर-PQ, गैर-फ़ायरवॉल वाले के समान ही एड्रेस/पोर्ट का उपयोग करें। एक या दोनों PQ संस्करण समर्थित हैं। राउटर एड्रेस में, MLKEM 512/768/दोनों को इंगित करने के लिए सामान्य की तरह v=2 और नया पैरामीटर pq=[3|4|3,4|4,3] प्रकाशित करें। नीचे निर्दिष्ट न्यूनतम से कम MTU वाले राउटर्स को "4" युक्त "pq" पैरामीटर प्रकाशित नहीं करना चाहिए। MLKEM-768 की पसंद दर्शाने के लिए 4,3 और MLKEM-512 की पसंद दर्शाने के लिए 3,4 प्रकाशित करें। वास्तविक संस्करण प्रारंभकर्ता पर निर्भर करता है, और पसंद को मान्यता नहीं दी जा सकती। नीचे निर्दिष्ट न्यूनतम से कम MTU वाले राउटर्स को MLKEM768 का उपयोग करके कनेक्ट नहीं होना चाहिए। पुराने राउटर pq पैरामीटर को अनदेखा कर देंगे और सामान्य की तरह गैर-pq के रूप में कनेक्ट होंगे।
...
I2P में MLDSA हस्ताक्षर समर्थन पर कार्य 2027 के अंत तक या 2028 तक स्थगित कर दिया गया है, जब तक मानक निकायों द्वारा एल्गोरिदम के चयन, संभवतः कुंजी और/या हस्ताक्षर आकार में कमी और उद्योग अपनाने को बढ़ावा देने का कार्य पूरा नहीं हो जाता। देखें [CABFORUM](https://cabforum.org/2024/10/10/2024-10-10-minutes-of-the-code-signing-certificate-working-group/), [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/), और [PLANTS](https://datatracker.ietf.org/wg/plants/about/)। इसके अलावा, उद्योग में MLDSA अपनाने को IETF, CA/Browser Forum और प्रमाणपत्र अधिकरण (Certificate Authorities) द्वारा मानकीकृत किया जाएगा। प्रमाणपत्र अधिकरणों को सबसे पहले हार्डवेयर सुरक्षा मॉड्यूल (HSM) समर्थन की आवश्यकता है, जो वर्तमान में उपलब्ध नहीं है [CA/Browser Forum](https://cabforum.org/2024/10/10/2024-10-10-minutes-of-the-code-signing-certificate-working-group/)। हम अपेक्षा करते हैं कि विशिष्ट पैरामीटर चयन पर निर्णय IETF और CA/Browser Forum द्वारा लिए जाएंगे, जिसमें यह भी शामिल होगा कि क्या संयुक्त हस्ताक्षरों का समर्थन किया जाए या उनकी आवश्यकता हो [COMPOSITE-SIGS](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/)।
...
SHA256 को अगले 20-30 वर्षों तक अच्छा माना जाना चाहिए, जिसे पोस्ट-क्वांटम (PQ) से खतरा नहीं है, देखें [NIST प्रस्तुति](https://csrc.nist.gov/csrc/media/Presentations/2022/update-on-post-quantum-encryption-and-cryptographi/Day%202%20-%20230pm%20Chen%20PQC%20ISPAB.pdf) और [NCCOE प्रस्तुति](https://www.nccoe.nist.gov/sites/default/files/2023-08/pqc-light-at-the-end-of-the-tunnel-presentation.pdf)। यदि SHA256 टूट जाता है तो हमारे पास और भी बड़ी समस्याएं होंगी (netdb)।

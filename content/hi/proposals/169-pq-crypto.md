...
| NTCP2 | बीटा Q1 2026 |
| SSU2 | जल्द ही लागू करना शुरू, बीटा Q2 2026 |
...
| प्रोटोकॉल / सुविधा | स्थिति |
|--------------------|--------|
| हाइब्रिड MLKEM रैचेट और LS | मंजूरी 2025-06; बीटा 2025-08; रिलीज 2025-11 |
| हाइब्रिड MLKEM NTCP2 | लाइव नेट पर परीक्षण किया गया, मंजूरी 2026-02; बीटा लक्ष्य 2026-05; रिलीज लक्ष्य 2026-08 |
| हाइब्रिड MLKEM SSU2 | मंजूरी 2026-02; बीटा लक्ष्य 2026-08; रिलीज लक्ष्य 2026-11 |
| MLDSA सिगटाइप्स 12-14 | प्रस्ताव स्थिर है लेकिन 2027 तक अंतिम रूप नहीं दिया जा सकता |
| MLDSA डेस्ट्स | लाइव नेट पर परीक्षण किया गया, फ्लडफिल समर्थन के लिए नेट अपग्रेड की आवश्यकता है |
| हाइब्रिड सिगटाइप्स 15-17 | प्रारंभिक |
| हाइब्रिड डेस्ट्स | |
## डिजाइन
...
इसलिए हम PQ-केवल और संकर हस्ताक्षर दोनों का समर्थन करेंगे। हम [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) के अनुसार तीन ML-DSA विविधताओं को परिभाषित करेंगे, Ed25519 के साथ तीन संकर विविधताएँ, और केवल SU3 फ़ाइलों के लिए प्रीहैश के साथ तीन PQ-केवल विविधताएँ, कुल 9 नए हस्ताक्षर प्रकारों के लिए। संकर प्रकार केवल Ed25519 के साथ संयोजन में परिभाषित किए जाएंगे। हम मानक ML-DSA का उपयोग करेंगे, SU3 फ़ाइलों को छोड़कर प्री-हैश विविधताओं (HashML-DSA) का नहीं।

हम [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) धारा 3.4 में परिभाषित "निर्धारक" (deterministic) संस्करण के बजाय "हेज़्ड" (hedged) या यादृच्छिकृत हस्ताक्षर संस्करण का उपयोग करेंगे। इससे यह सुनिश्चित होता है कि प्रत्येक हस्ताक्षर भले ही उसी डेटा पर हो, अलग हो, और साइड-चैनल हमलों के खिलाफ अतिरिक्त सुरक्षा प्रदान करता है। एल्गोरिथ्म चयन सहित एन्कोडिंग और संदर्भ के बारे में अतिरिक्त जानकारी के लिए नीचे दिए गए लागूकरण टिप्पणियों के अनुभाग देखें।
...
| MLDSA65ph | 19 |
| MLDSA87ph | 20 |
X.509 प्रमाणपत्र और अन्य DER एन्कोडिंग [IETF ड्राफ्ट](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में परिभाषित संरचनाओं और OID का उपयोग करेंगे।

ओवरहेड काफी अधिक होगा। आम Ed25519 गंतव्य और राउटर पहचान आकार 391 बाइट्स होते हैं। ये एल्गोरिदम के आधार पर 3.5x से 6.8x तक बढ़ जाएंगे। Ed25519 हस्ताक्षर 64 बाइट्स के होते हैं। ये एल्गोरिदम के आधार पर 38x से 76x तक बढ़ जाएंगे। सामान्य हस्ताक्षरित RouterInfo, LeaseSet, उत्तर योग्य डेटाग्राम और हस्ताक्षरित स्ट्रीमिंग संदेश लगभग 1KB के होते हैं। ये एल्गोरिदम के आधार पर 3x से 8x तक बढ़ जाएंगे।

चूँकि नया गंतव्य और राउटर पहचान प्रकार पैडिंग नहीं रखेंगे, इसलिए उन्हें संपीड़ित नहीं किया जा सकेगा। गंतव्यों और राउटर पहचानों के आकार जो ट्रांज़िट में gzip किए गए होंगे, एल्गोरिदम के आधार पर 12x से 38x तक बढ़ जाएंगे।
...
राउटर पहचानों के लिए, एल-गामल एन्क्रिप्शन प्रकार को अब समर्थित नहीं किया जाता है। नए हस्ताक्षर प्रकार केवल X25519 (प्रकार 4) एन्क्रिप्शन के साथ समर्थित हैं। नए एन्क्रिप्शन प्रकार राउटर पतों में दर्शाए जाएंगे। कुंजी प्रमाणपत्र में एन्क्रिप्शन प्रकार अब भी प्रकार 4 ही रहेगा।
...
ध्यान दें कि जावा बाउंसीकासल लाइब्रेरी उपरोक्त सभी को समर्थन देती है। सी++ लाइब्रेरी समर्थन OpenSSL 3.5 में है [OpenSSL](https://openssl-library.org/post/2025-02-04-release-announcement-3.5/)।

### विकल्प

हम [FIPS 205](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.205.pdf) (Sphincs+) का समर्थन नहीं करेंगे, यह ML-DSA की तुलना में बहुत धीमा और आकार में बड़ा है। हम आगामी FIPS206 (Falcon) का समर्थन नहीं करेंगे, क्योंकि यह अभी तक मानकीकृत नहीं हुआ है। हम NTRU या अन्य PQ उम्मीदवारों का समर्थन नहीं करेंगे जिन्हें NIST द्वारा मानकीकृत नहीं किया गया है।

### Rosenpass

Wireguard (IK) को शुद्ध PQ क्रिप्टो के लिए अनुकूलित करने पर कुछ शोध [पत्र](https://eprint.iacr.org/2020/379.pdf) उपलब्ध हैं, लेकिन उस पत्र में कई खुले प्रश्न हैं। बाद में, PQ Wireguard के लिए रोजेनपास [Rosenpass](https://rosenpass.eu/) [व्हाइटपेपर](https://raw.githubusercontent.com/rosenpass/rosenpass/papers-pdf/whitepaper.pdf) के रूप में इस दृष्टिकोण को लागू किया गया।

रोजेनपास क्लासिक मैकेलीस 460896 स्टेटिक कुंजियों (प्रत्येक 500 KB) और काइबर-512 (मूल रूप से MLKEM-512) अस्थायी कुंजियों के साथ एक नॉइज़ KK-जैसी हैंडशेक का उपयोग करता है। चूंकि क्लासिक मैकेलीस साइफरटेक्स्ट केवल 188 बाइट्स के होते हैं, और काइबर-512 की सार्वजनिक कुंजियाँ और साइफरटेक्स्ट उचित आकार के होते हैं, इसलिए दोनों हैंडशेक संदेश एक मानक UDP MTU में फिट हो जाते हैं। PQ KK हैंडशेक से प्राप्त आउटपुट साझा कुंजी (osk) का उपयोग मानक वायरगार्ड IK हैंडशेक के लिए इनपुट प्रीशेयर्ड कुंजी (psk) के रूप में किया जाता है। इस प्रकार कुल मिलाकर दो पूर्ण हैंडशेक होते हैं, एक शुद्ध PQ और एक शुद्ध X25519।
...
व्हाइटपेपर में बहुत अच्छी जानकारी है, और हम विचारों और प्रेरणा के लिए इसकी समीक्षा करेंगे। TODO।

## विशिष्टता

### सामान्य संरचनाएं

सामान्य संरचनाओं दस्तावेज़ [/docs/specs/common-structures/](/docs/specs/common-structures/) में खंडों और तालिकाओं को निम्नानुसार अपडेट करें:
...
हाइब्रिड सार्वजनिक कुंजियाँ X25519 कुंजी हैं। KEM सार्वजनिक कुंजियाँ ऐलिस द्वारा बॉब को भेजी गई अस्थायी PQ कुंजी हैं। एन्कोडिंग और बाइट ऑर्डर [FIPS 203](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.203.pdf) में परिभाषित हैं।

MLKEM*_CT कुंजियाँ वास्तव में सार्वजनिक कुंजियाँ नहीं हैं, बल्कि नॉइज़ हैंडशेक में बॉब से एलिस को भेजा गया "साइफरटेक्स्ट" है। पूर्णता के लिए यहाँ इनका सूचीकरण किया गया है।
...
हाइब्रिड निजी कुंजियाँ X25519 कुंजियाँ हैं। KEM निजी कुंजियाँ केवल एलिस के लिए हैं। KEM एन्कोडिंग और बाइट ऑर्डर [FIPS 203](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.203.pdf) में परिभाषित हैं।
...
हाइब्रिड साइनिंग सार्वजनिक कुंजियाँ Ed25519 कुंजी के बाद PQ कुंजी होती हैं, जैसा कि [IETF ड्राफ्ट](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में दिया गया है। एन्कोडिंग और बाइट ऑर्डर को [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) में परिभाषित किया गया है।
...
हाइब्रिड साइनिंग निजी कुंजियाँ Ed25519 कुंजी के बाद PQ कुंजी होती हैं, जैसा कि [IETF ड्राफ्ट](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में दिया गया है। एन्कोडिंग और बाइट ऑर्डर [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) में परिभाषित हैं।

### हस्ताक्षर

नए सिग्नेचर प्रकार हैं:
...
हाइब्रिड हस्ताक्षर Ed25519 हस्ताक्षर के बाद PQ हस्ताक्षर होते हैं, जैसा कि [IETF ड्राफ्ट](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/) में दिया गया है। हाइब्रिड हस्ताक्षरों को दोनों हस्ताक्षरों को सत्यापित करके और यदि कोई भी एक विफल हो जाए तो विफल घोषित करके सत्यापित किया जाता है। एन्कोडिंग और बाइट ऑर्डर को [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf) में परिभाषित किया गया है।
...
हस्ताक्षर रोलआउट एन्क्रिप्शन रोलआउट की तुलना में एक या अधिक वर्ष बाद होगा, क्योंकि पीछे की ओर संगतता संभव नहीं है। साथ ही, उद्योग में MLDSA को अपनाने को CA/ब्राउज़र फोरम और प्रमाणपत्र अधिकरण (Certificate Authorities) द्वारा मानकीकृत किया जाएगा। प्रमाणपत्र अधिकरणों को पहले हार्डवेयर सुरक्षा मॉड्यूल (HSM) समर्थन की आवश्यकता है, जो वर्तमान में उपलब्ध नहीं है [CA/Browser Forum](https://cabforum.org/2024/10/10/2024-10-10-minutes-of-the-code-signing-certificate-working-group/)। हम उम्मीद करते हैं कि विशिष्ट पैरामीटर चयन पर निर्णय लेने में CA/ब्राउज़र फोरम की अगुवाई होगी, जिसमें संयुक्त हस्ताक्षरों का समर्थन करने या आवश्यक करने सहित [IETF draft](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/)।

| मील का पत्थर | लक्ष्य |
|-----------|--------|
| रैचेट बीटा | देर 2025 |
| सर्वोत्तम एन्क्रिप्शन प्रकार चुनें | शुरुआत 2026 |
| NTCP2 बीटा | शुरुआत 2026 |
| SSU2 बीटा | मध्य 2026 |
| रैचेट उत्पादन | मध्य 2026 |
| रैचेट डिफ़ॉल्ट | देर 2026 |
| सिग्नेचर बीटा | देर 2026 |
| NTCP2 उत्पादन | देर 2026 |
| SSU2 उत्पादन | शुरुआत 2027 |
| सर्वोत्तम सिग्नेचर प्रकार चुनें | शुरुआत 2027 |
| NTCP2 डिफ़ॉल्ट | शुरुआत 2027 |
| SSU2 डिफ़ॉल्ट | मध्य 2027 |
| सिग्नेचर उत्पादन | मध्य 2027 |
## माइग्रेशन

यदि हम एक ही टनल पर पुराने और नए रैचेट प्रोटोकॉल दोनों का समर्थन नहीं कर सकते हैं, तो माइग्रेशन कहीं अधिक कठिन हो जाएगा।

हमें केवल एक-फिर-दूसरे का प्रयास करने में सक्षम होना चाहिए, जैसा कि हमने X25519 के साथ किया था, इसे सिद्ध करने के लिए।

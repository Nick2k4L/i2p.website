...
- **Reseed 工具（引导获取网络节点）**: 来自 [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools) 的官方 reseed-tools
...
由 I2P 项目维护的官方实现。代码仓库：[i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)
...
由 PurpleI2P 项目提供的替代实现: [PurpleI2P/pyseeder](https://github.com/PurpleI2P/pyseeder)
...
**文档**: [Notes on I2P reseed over Cloudflare](https://homepage.np-tokumei.net/post/notes-i2p-reseed-over-cloudflare/)
...
**研究文档**: [Censorship-resistant reseeding notes](https://homepage.np-tokumei.net/post/notes-censorship-resistant-i2p-reseeding/)
...
位于 [checki2p.com/reseed](https://checki2p.com/reseed) 的服务会每 4 小时对所有已注册的 I2P reseed 服务器（引导服务器）进行自动化检查。其提供：
...
- **Reseed 工具仓库**: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)
- **Reseed 工具文档**: [eyedeekay.github.io/reseed-tools](https://eyedeekay.github.io/reseed-tools/)
...
- **Python WSGI reseeder（重新播种服务器）**: [torbjo/i2p-reseeder](https://github.com/torbjo/i2p-reseeder)

### 社区资源

- **I2P 论坛**: [i2pforum.net](https://i2pforum.net/)
- **Gitea 仓库**: `https://i2pgit.org/I2P_Developers/i2p.i2p`
- **IRC**: IRC2P 上的 #i2p-dev
- **状态监控**: [checki2p.com/reseed](https://checki2p.com/reseed)

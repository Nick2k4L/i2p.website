...
- 这是客户端发送的第二条消息。之前客户端发送了一个 [GetDateMessage](#GetDateMessage) 并收到了一个 [SetDateMessage](#SetDateMessage) 响应。
...
从客户端发送到 router。router 会响应一个 [SetDateMessage](#SetDateMessage)。

...
BOB 是 [Basic Open Bridge](/docs/legacy/bob/)（基本开放桥接），允许任何语言的应用程序建立到 I2P 和从 I2P 的流连接。目前它缺乏 UDP 支持，但计划在不久的将来支持 UDP。BOB 还包含几个工具，如目标密钥生成，以及验证地址是否符合 I2P 规范。最新信息和使用 BOB 的应用程序可以在这个 I2P 站点 找到。
...
- I2P-Bote - 联系 HungryHobo
- [Syndie](http://syndie.i2p2.de/)
- IMule
- I2Phex

另请参阅 plugins.i2p 上的所有插件、echelon.i2p 上列出的应用程序和源代码，以及托管在 git.repo.i2p 上的应用程序代码。

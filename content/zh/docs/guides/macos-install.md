...
aliases:
  - "/zh/docs/guides/installing-i2p-on-macos-the-long-way"
  - "/zh/docs/guides/installing-i2p-on-macos-the-long-way/"
...
4. **监控您的 router**：[控制台](http://127.0.0.1:7657/console)显示您的网络状态和统计信息
...
1. 前往 [I2P Setup Wizard](http://127.0.0.1:7657/welcome)
2. 再次按照向导步骤操作

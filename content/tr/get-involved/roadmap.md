...
**Yayın Döngüsü:** Ana sürümler için yaklaşık her 13 haftada bir

**Destek Politikası:** - **Mevcut sürüm**: Güncellemeler ve güvenlik yamaları ile tam destek - **Önceki sürüm**: Sadece güvenlik güncellemeleri - **Eski sürümler**: Artık desteklenmiyor (yükseltme önerilir)

**Sürüm Numaralandırması:** - 0.9.x serisi ile başladı (0.9.66'ya kadar) - 1.x serisine geçiş yapıldı (1.5.0'dan 1.9.0'a kadar) - Şimdi 2.x serisinde (2.0.0+)

---

## Geliştirme Kaynakları

- **Kaynak Kod**: [i2pgit.org](https://i2pgit.org)
- **Sorun İzleyici**: i2pgit.org veya github sorunları
- **Aylık Toplantılar**: Şu anda aktif değil
- **IRC**: IRC2P üzerinde #i2p-dev
- **Sürüm Notları**: [I2P Blog](/blog/)

---

## Katılın

I2P'nin geleceğine katkıda bulunmak mı istiyorsunuz? Geliştirme, test etme, dokümantasyon ve daha fazlasında nasıl yardımcı olabileceğinizi öğrenmek için [Katılın](/en/get-involved) sayfasını inceleyin!

En güncel haberler ve detaylı sürüm bilgileri için [I2P Blog](/en/blog)'u ziyaret edin.

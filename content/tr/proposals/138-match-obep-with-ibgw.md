...
Çoğu I2P yönlendiricisi, tıkanıklık yönetimi için bir çeşit paket düşürme kullanır. Referans uygulama, hem mesaj boyutunu hem de seyahat mesafesini dikkate alan bir WRED stratejisi kullanır (bkz. [tunnel throttling belgeleri](/docs/specs/tunnel-implementation/#tunnelthrottling)). Bu strateji nedeniyle, paket kaybının ana kaynağı OBEP'tir.

...
[Tunnel Creation ECIES specification](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) yer alıyor.
...
Bant genişliği parametrelerini, tünel oluşturma seçenekleri haritalama alanındaki ECIES tünel oluşturma mesajlarındaki kayıtlara ekleyin (bkz. [Tunnel Creation ECIES specification](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)).
...
[ECIES tünel oluşturma mesaj spesifikasyonunu](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) güncelleyin
aşağıdaki gibi:

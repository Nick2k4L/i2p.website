...
Tunnely jsou vybudovány a následně používány s vrstveným šifrováním. Toto je popsáno na [stránce implementace tunnelů](/docs/specs/implementation/). Pro šifrování používáme [ElGamal/AES+SessionTag](/docs/specs/elgamal-aes/).

...
![Inbound and outbound tunnel schematic](/images/tunnels.png) *Obrázek 1: Existují dva typy tunnelů: příchozí a odchozí.*
...
![Vyžádat informace o ostatních routerech](/images/netdb_get_routerinfo_1.png)

![Build tunnel using router information](/images/netdb_get_routerinfo_2.png) *Obrázek 2: Informace o routeru se používají k budování tunelů.*
...
![Connect tunnels using LeaseSets](/images/netdb_get_leaseset.png) *Obrázek 3: LeaseSets se používají k propojení odchozích a příchozích tunelů.*
...
Jak bylo zmíněno dříve, I2P v současnosti (verze 0.8) zahrnuje výše uvedenou vícevrstvou náhodnou strategii s řazením založeným na XOR. Podrobnější diskuze o mechanismech zapojených do provozu tunelů, jejich správy a výběru peerů lze nalézt ve [specifikaci tunelů](/docs/specs/implementation/).

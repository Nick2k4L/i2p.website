...
1. Otevřete `http://127.0.0.1:7657/`
2. Přejděte na `http://127.0.0.1:7657/confignet`
...
1. Navštivte `http://127.0.0.1:7657/config.jsp`
...
- Prozkoumejte `http://127.0.0.1:7657/` pro sledování vašeho routeru

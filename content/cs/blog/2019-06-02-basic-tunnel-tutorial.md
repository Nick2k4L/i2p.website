...
Přejděte do webového rozhraní I2P na adrese 127.0.0.1:7657 a otevřete `http://127.0.0.1:7657/i2ptunnelmgr` (odkazuje na localhost). Klikněte na tlačítko "Tunnel Wizard" a začněte.

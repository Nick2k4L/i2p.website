...
[Tunnel Creation ECIES specification](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) od API 0.9.65.
...
Přidat parametry šířky pásma do záznamů v ECIES zprávách o vytvoření tunelu (viz [Tunnel Creation ECIES specification](/docs/specs/tunnel-implementation/#tunnel-creation-ecies))
...
Aktualizujte [specifikaci zprávy o vytvoření tunelu ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
takto:

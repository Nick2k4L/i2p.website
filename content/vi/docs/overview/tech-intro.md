...
Như đã đề cập trước đó, I2P hiện tại (phiên bản 0.8) bao gồm chiến lược ngẫu nhiên phân tầng ở trên, với thứ tự dựa trên XOR. Thảo luận chi tiết hơn về cơ chế liên quan đến hoạt động tunnel, quản lý, và lựa chọn peer có thể được tìm thấy trong [tunnel spec](/docs/specs/implementation/).

...
I2P Router Console là trung tâm điều khiển chính để quản lý và giám sát router I2P của bạn. Theo mặc định, bạn có thể truy cập tại `http://127.0.0.1:7657/home` sau khi router I2P của bạn đã chạy.
...
**Lưu ý Bảo mật:** Bảo vệ bằng mật khẩu chỉ ảnh hưởng đến quyền truy cập vào giao diện web bảng điều khiển router tại `http://127.0.0.1:7657`. Nó không mã hóa lưu lượng I2P hoặc ngăn chặn các ứng dụng sử dụng I2P. Nếu bạn là người dùng duy nhất trên máy tính của mình và bảng điều khiển router chỉ lắng nghe trên localhost (mặc định), mật khẩu có thể không cần thiết.
...
Nếu bạn đang gặp vấn đề với I2P: 1. Kiểm tra FAQ để tìm các câu hỏi và câu trả lời thường gặp 2. Xem lại phần khắc phục sự cố cho vấn đề cụ thể của bạn 3. Truy cập diễn đàn I2P tại i2pforum.i2p hoặc [i2pforum.net](https://i2pforum.net) 4. Tham gia kênh IRC #i2p để nhận hỗ trợ từ cộng đồng theo thời gian thực 5. Tìm kiếm trong tài liệu để có thông tin kỹ thuật chi tiết

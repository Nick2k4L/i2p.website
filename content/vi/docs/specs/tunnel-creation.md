...
Chiến lược này được đưa ra trong một cuộc thảo luận trên danh sách gửi thư I2P giữa Michael Rogers, Matthew Toseland (toad), và jrandom về cuộc tấn công predecessor. Xem TUNBUILD-SUMMARY, TUNBUILD-REASONING. Nó được giới thiệu trong phiên bản 0.6.1.10 vào ngày 2006-02-16, đây là lần cuối cùng một thay đổi không tương thích ngược được thực hiện trong I2P.

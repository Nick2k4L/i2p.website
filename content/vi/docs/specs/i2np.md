...
ID của tin nhắn đã được gửi và thời gian tạo hoặc thời gian nhận.
...
Cảnh báo: Đây là định dạng được sử dụng cho các garlic message được mã hóa ElGamal [CRYPTO-ELG](/docs/specs/cryptography/#elgamal). Định dạng cho các garlic message và garlic clove ECIES-AEAD-X25519-Ratchet khác biệt đáng kể; xem [ECIES](/docs/specs/ecies/) để biết thông số kỹ thuật.

#### Mô tả

Được sử dụng để bao bọc nhiều I2NP Messages được mã hóa

#### Nội dung

Khi được giải mã, một chuỗi các [Garlic Cloves](#struct-GarlicClove) và dữ liệu bổ sung, còn được gọi là Clove Set.
...
```
Dữ liệu đã giải mã, còn được gọi là Clove Set:
...
Một thông điệp được gửi từ gateway hoặc participant của tunnel tới participant hoặc endpoint tiếp theo. Dữ liệu có độ dài cố định, chứa các thông điệp I2NP đã được phân mảnh, gộp lại, đệm và mã hóa.
...
Đóng gói một thông điệp I2NP khác để gửi vào tunnel tại cổng vào của tunnel.
...
Được sử dụng bởi Garlic Messages và Garlic Cloves để bọc dữ liệu tùy ý.

#### Mục lục

Một số nguyên độ dài, theo sau bởi dữ liệu mờ đục.
...
ĐÃ LẠC HẬU, sử dụng [VariableTunnelBuild](#msg-VariableTunnelBuild)
...
ĐÃ LỖI THỜI, sử dụng [VariableTunnelBuildReply](#msg-VariableTunnelBuildReply)
...
Tính từ phiên bản API 0.9.51, chỉ dành cho các router ECIES-X25519.
...
Được gửi từ điểm cuối outbound của một tunnel mới đến người khởi tạo. Kể từ phiên bản API 0.9.51, chỉ dành cho các router ECIES-X25519.

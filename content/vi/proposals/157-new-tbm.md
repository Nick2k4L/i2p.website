...
Xem [I2NP](/docs/specs/i2np/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) để biết đặc tả cuối cùng.
...
Các thay đổi đối với định dạng bản ghi 528 byte cho các bộ định tuyến ECIES-X25519 được chỉ định trong [Prop152](/proposals/152-ecies-tunnels/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
- Duy trì đủ không gian cho các tùy chọn trong tương lai, như trong [Prop152](/proposals/152-ecies-tunnels/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
- Phù hợp trong một thông điệp đường hầm cho đường ngược
- Chỉ hỗ trợ các bước ECIES
- Duy trì các cải tiến được triển khai trong [Prop152](/proposals/152-ecies-tunnels/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
...
và 464 byte cho các bản ghi ECIES như được định nghĩa trong [Prop152](/proposals/152-ecies-tunnels/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).

Các bản ghi phản hồi dạng văn bản sẽ là 202 byte,
so với 496 byte cho các bản ghi ElGamal,
và 512 byte cho các bản ghi ECIES như được định nghĩa trong [Prop152](/proposals/152-ecies-tunnels/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
Mã hóa bản ghi yêu cầu và trả lời: như đã định nghĩa trong [Prop152](/proposals/152-ecies-tunnels/) và [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
Tóm tắt các thay đổi từ [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies):
...
Trường cờ giữ nguyên như được định nghĩa trong [Tunnel-Creation](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) và chứa các giá trị sau::
...
như được định nghĩa trong [Tunnel-Creation](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) để tránh nhận diện:

...
```
LƯU Ý: RI có thể được gửi dưới dạng các tin nhắn Lưu trữ Cơ sở dữ liệu I2NP trong các khối I2NP, hoặc dưới dạng các khối RI (nếu đủ nhỏ). Chúng có thể được chứa trong cùng các gói tin với các khối chuyển tiếp, nếu kích thước đủ nhỏ.

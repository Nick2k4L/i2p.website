...
Thêm MixHash(hash định danh của Bob) vào trạng thái NOISE của thông điệp "SessionRequest", ví dụ: h = SHA256 (h || hash định danh của Bob). Nó phải là MixHash cuối cùng được sử dụng như ad cho MÃ HÓA hoặc GIẢI MÃ. Cần thêm cờ tiêu đề SSU2 bổ sung "Xác minh định danh Bob" = 0x02.

...
0.9.11 continue d’améliorer la recherche et le stockage des LeaseSet afin d’empêcher un attaquant de corréler une Destination avec un Router. Il ajoute la prise en charge du plugin outproxy (proxy de sortie) [Orchid](http://www.subgraph.com/orchid.html) qui est disponible sur plugins.i2p. On observe une réduction de la consommation mémoire grâce à des correctifs dans les transports. Nous avons apporté quelques améliorations au protocole I2CP qui fourniront de meilleures capacités de recherche et une protection d’autorisation pour les clients externes. Bien sûr, il y a aussi la collection habituelle de corrections de bogues. Tous les utilisateurs devraient mettre à jour.

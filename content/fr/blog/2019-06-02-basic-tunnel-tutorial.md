...
Accédez à l'interface web d'I2P à l'adresse 127.0.0.1:7657 et ouvrez le `http://127.0.0.1:7657/i2ptunnelmgr` (lien vers localhost). Cliquez sur le bouton "Tunnel Wizard" pour commencer.

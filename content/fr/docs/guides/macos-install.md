---
title: "Installation d'I2P sur macOS"
aliases:
  - "/fr/docs/guides/installing-i2p-on-macos-the-long-way"
  - "/fr/docs/guides/installing-i2p-on-macos-the-long-way/"
...
Ce processus d'installation comprend quatre étapes principales :

1. **Installer Java** - Téléchargez et installez l'environnement d'exécution Oracle Java
2. **Installer I2P** - Téléchargez et exécutez l'installateur I2P
...
Localisez le fichier `.dmg` téléchargé dans votre dossier Téléchargements et double-cliquez dessus pour l'ouvrir.
...
Cliquez sur **Installer** pour commencer le processus d'installation de Java.
...
![Attendez que l'installateur se termine](/images/guides/macos-install/4-jre.png)
...
![Installation Java terminée](/images/guides/macos-install/5-jre.png)

## Deuxième partie : Télécharger et installer I2P

Maintenant que Java est installé, vous pouvez installer le router I2P.

### Étape 1 : Télécharger I2P

Visitez la [page de téléchargements](/downloads/) et téléchargez l'installateur **I2P pour Unix/Linux/BSD/Solaris** (le fichier `.jar`).
...
Succès ! I2P est maintenant installé. Cliquez sur **Terminé** pour finir.
...
Cliquez sur l'icône I2P dans votre Dock (ou double-cliquez sur le lanceur). Votre navigateur web par défaut s'ouvrira sur la Console du Router I2P.
...
### Étape 7 : Configurer le partage de bande passante

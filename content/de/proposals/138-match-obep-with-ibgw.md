...
Die meisten I2P-Router verwenden eine Form der Paketabwurfsteuerung zur Überlastungsverwaltung. Die Referenzimplementierung nutzt eine WRED-Strategie, die sowohl die Nachrichtengröße als auch die Reisedistanz berücksichtigt (siehe [Tunnel Throttling Dokumentation](/docs/specs/tunnel-implementation/#tunnelthrottling)). Aufgrund dieser Strategie ist die Hauptquelle für Paketverlust der OBEP.

...
```
HINWEIS: Die RI kann entweder als I2NP Database Store-Nachrichten in I2NP-Blöcken oder als RI-Blöcke (sofern klein genug) gesendet werden. Diese können, sofern klein genug, in denselben Paketen wie die Relay-Blöcke enthalten sein.

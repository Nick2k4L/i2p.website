...
كما ذُكر سابقاً، يتضمن I2P حالياً (الإصدار 0.8) الاستراتيجية العشوائية المتدرجة أعلاه، مع ترتيب قائم على XOR. يمكن العثور على نقاش أكثر تفصيلاً حول الآليات المشاركة في تشغيل tunnel وإدارته واختيار النظراء في [مواصفات tunnel](/docs/specs/tunnel-implementation/).

...
سيحتاج شخص ما إلى تزويدك بملف torrent أو رابط magnet يتوافق مع `git bundle` موجود قام بإنشائه لك مسبقاً. يمكن العثور على حزمة حديثة ومُنشأة بشكل صحيح لكود مصدر i2p.i2p الرئيسي اعتباراً من يوم الأربعاء، 18 مارس 2020، داخل I2P في pastebin الخاص بي [paste.idk.i2p/f/4hq37i](http://paste.idk.i2p/f/4h137i).

...
حقل الإصدار في الرأس الطويل لرسالة طلب الجلسة هو 2 للإصدار غير المحمي بالتحصين الكمي (non-PQ)، و3 لـ MLKEM-512، و4 لـ MLKEM-768. ويتيح لنا هذا تشغيل كل من SSU2 القياسي وSSU2 الهجين على نفس المنفذ، ودعم كلا إصدارتي MLKEM في آنٍ واحد.

## توافق الـ Router

### أسماء وسائل النقل

في جميع الحالات، استخدم اسم النقل SSU2 كما هو معتاد. ستجاهل الراوترات الأقدم المعامل pq وستتصل عبر SSU2 القياسي كما هو معتاد.

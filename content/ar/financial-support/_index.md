...
/* ── تخطيط من عمودين مع جدول المحتويات ── */   .support-layout {
...
/* ── تنسيق القسم مع خلفيات متناوبة ── */   .support-section {
...
/* ── قائمة علامات الاختيار ── */   .support-list {
...
/* ── بطاقات التبرع المشفرة ── */   .donation-methods {
...
/* ── بطاقات مستويات الرعاية ── */   .tier-grid {

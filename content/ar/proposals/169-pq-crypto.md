...
لـ XK: بعد نمط الرسالة 'es' وقبل الحمولة، أضف:
...
- (0) طلب جلسة
- (1) تم إنشاء الجلسة
- (9) إعادة المحاولة (ملاحظة: إعادة المحاولة مع الإنهاء قد تحتوي أي إصدار من 2 إلى 4)
- (10) طلب الرمز المميز

في الرسالة التالية، قم بتعيين حقل ver (الإصدار) في الرأس الطويل إلى أي إصدار من 2 إلى 4، لأن اختيار الإصدار يعود إلى أليس وليس تشارلي. من المقبول دائمًا تعيينه إلى 2. يجب أن تقبل التنفيذات أي قيمة بين 2 و4.

- (11) ثقب الثقب

في الرسالة التالية، قم بتعيين حقل ver (الإصدار) في الرأس الطويل إلى 2، كما هو معتاد، حتى لو كان MLKEM-512 أو MLKEM-768 مدعومًا. يمكن للتنفيذات أيضًا تعيين القيمة إلى 3 أو 4، إذا كان الطرف الآخر يدعم ذلك، ولكن هذا ليس ضروريًا. يجب أن تقبل التنفيذات أي قيمة بين 2 و4.

- (7) اختبار الند (الرسائل خارج الجلسة 5-7)

النقاش: قد لا يكون تعيين حقل الإصدار إلى 3 أو 4 ضروريًا بشكل صارم لجميع أنواع الرسائل، ولكن القيام بذلك يساعد في اكتشاف الأعطال مبكرًا بالنسبة للاتصالات غير المدعومة ما بعد الكم. ينبغي أن تكون إصدارات رسائل طلب الرمز (Token Request) وإعادة المحاولة (Retry) (النوعان 9 و10) 3/4 لضمان الاتساق. رسائل اختبار الند (Peer Test) (النوع 7) تكون خارج الجلسة ولا تدل على نية بدء جلسة.
...
```
  ...
  +----+----+----+----+----+----+----+----+
```
الأحجام، لا تتضمن الحمولة الإضافية لـ IP:
...
- SAMv3
- مشاركة التورنت (Bittorrent)
- إرشادات المطورين
- الأسماء / دفتر العناوين / خوادم الانتقال (Naming / addressbook / jump servers)
- وثائق أخرى
...
- إذا كانت الرسالة 1 أقل من 919 بايت، فهي بروتوكول الراتشيت الحالي.
- إذا كانت الرسالة 1 أكبر من أو تساوي 919 بايت، فمن المرجح أنها MLKEM512_X25519.
جرّب MLKEM512_X25519 أولاً، وإذا فشل، فجرّب بروتوكول الراتشيت الحالي.

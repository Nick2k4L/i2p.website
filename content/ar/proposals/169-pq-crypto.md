...
الحجم الأقصى: ليس لدى آليس بعد معلومات الموجه الخاصة ببوب ولا تعرف MTU المنشور لديه. بالنسبة لهذه الرسالة، استخدم MTU مؤقتًا على النحو التالي. بالنسبة لـ MLKEM512_X25519، استخدم الحد الأقصى بين 1280 أو حجم SessionRequest المستلم كقيمة MTU. وبالنسبة لـ MLKEM768_X25519، استخدم الحد الأقصى بين (1318 للبروتوكول IPv4 أو 1338 للبروتوكول IPv6) أو حجم SessionRequest المستلم كقيمة MTU. إن حجم الرأس في SessionCreated أصغر من حجم الرأس في SessionRequest، لأن نص MLKEM المشفر أصغر من المفتاح العمومي لـ MLKEM. وهذا يسمح بمجموعة من أحجام الحشو في SessionCreated حتى لو كان هناك حشو ضئيل أو معدوم في SessionRequest.

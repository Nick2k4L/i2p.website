...
بالنسبة لأليس، بعد تشفير الرسالة باستخدام Noise، وقبل التمويه AES لقيمة X، اضبط X[31] |= 0x80.
...
```
  ...
  +----+----+----+----+----+----+----+----+
```
ملاحظة: يجب تعيين حقل الإصدار في كتلة خيارات الرسالة 1 إلى 2، حتى بالنسبة للاتصالات PQ.

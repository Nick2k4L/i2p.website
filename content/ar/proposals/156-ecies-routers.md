...
- تم تنفيذ بناء الأنفاق اعتبارًا من 0.9.48، راجع [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
تتطلب عدة تغييرات لمواصفات إنشاء النفق [Tunnel-Creation](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
...
تشفير الطلب هو نفسه الذي تم تحديده في [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) و [Prop152](/proposals/152-ecies-tunnels/),
...
هذا هو نفس ما تم تحديده في [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) و [Prop152](/proposals/152-ecies-tunnels/) لرسائل بناء النفق.

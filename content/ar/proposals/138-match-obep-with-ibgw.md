...
تستخدم معظم موجهات I2P نوعًا من إسقاط الحزم لإدارة الاحتقان. يستخدم التنفيذ المرجعي استراتيجية WRED التي تأخذ في الاعتبار حجم الرسالة ومسافة السفر (راجع [وثائق tunnel throttling](/docs/specs/tunnel-implementation/#tunnelthrottling)). بسبب هذه الاستراتيجية، يكون المصدر الأساسي لفقدان الحزم هو OBEP.

...
travel distance into account (see [tunnel throttling documentation](/docs/specs/tunnel-implementation/#tunnelthrottling)). Due to this strategy, the
...
* [TUNNEL-THROTTLING](/docs/specs/tunnel-implementation/#tunnel.throttling)

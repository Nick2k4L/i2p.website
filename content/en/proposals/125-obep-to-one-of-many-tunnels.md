...
[RouterIdentity](/docs/specs/common-structures/#common-structure-specification) hash. This would result in a smaller message and a potentially
...
The originator (OBGW) would place some (all?) of the target [Leases](/docs/specs/common-structures/#lease) in the
...
* The OBGWs must select compatible OBEPs when building outbound tunnels, based
  on the I2P version advertised in their [RouterInfo](/docs/specs/common-structures/#routerinfo).

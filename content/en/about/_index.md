...
There are a great many other applications and projects working on anonymous communication and I2P has been inspired by much of their efforts. This is not a comprehensive list of anonymity resources - both [freehaven's Anonymity Bibliography](http://freehaven.net/anonbib/topic.html) and [GNUnet's related projects](https://www.gnunet.org/en/) serve that purpose well. That said, a few systems stand out for further comparison. Learn more about how I2P compares to other anonymity networks in our [detailed comparison documentation](/docs/overview/comparison/). 
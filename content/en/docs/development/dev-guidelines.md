...
type: docs
aliases:
  - "/en/docs/develop/dev-guidelines"
  - "/en/docs/develop/dev-guidelines/"
...
- Managing issues is everybody's job; please help. Monitor GitLab for issues you can help with. Comment on, fix, and close issues if you can.

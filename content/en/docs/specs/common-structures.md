...
#### Notes
* **Flags** (2 bytes):
  * Bit 0: If set, offline keys are present (see [OfflineSignature](#offlinesignature))
  * Bit 1: If set, this is an unpublished leaseset
  * Bit 2: If set, this is a blinded leaseset

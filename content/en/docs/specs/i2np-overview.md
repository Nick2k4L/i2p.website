---
title: "I2NP Overview"
description: "Overview of the I2P Network Protocol (I2NP) - message format, types, priorities, and size constraints."
slug: "i2np-overview"
aliases:
...
The priorities listed below may not be current and are subject to change. Priority queueing implementation may vary.
...
While the maximum payload size is nominally 64KB, the size is further constrained by the method of fragmenting I2NP messages into multiple 1KB tunnel messages as described on the [tunnel implementation page](/docs/specs/tunnel-implementation/).

The maximum number of fragments is 64, and the message may not be perfectly aligned, so the message must nominally fit in 63 fragments.
...
See the [I2NP Specification page](/docs/specs/i2np/) for the full protocol specification. See also the [Common Data Structure Specification page](/docs/specs/common-structures/).

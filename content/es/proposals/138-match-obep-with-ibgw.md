...
La mayoría de los routers I2P emplean una forma de eliminación de paquetes para la gestión de la congestión. La implementación de referencia utiliza una estrategia WRED que toma en cuenta tanto el tamaño del mensaje como la distancia de viaje (véase [documentación de tunnel throttling](/docs/specs/tunnel-implementation/#tunnelthrottling)). Debido a esta estrategia, la principal fuente de pérdida de paquetes es el OBEP.

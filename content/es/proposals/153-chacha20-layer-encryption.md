...
Para una descripción general del procesamiento actual de mensajes de túnel, consulte la especificación [Tunnel Implementation](/docs/specs/tunnel-implementation/).

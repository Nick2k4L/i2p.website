...
description: "Esquema de firma re-aleatorizable para crear Destinations ciegos"
slug: "red25519"
aliases:
  - "/es/docs/specs/red25519-signature-scheme"
  - "/es/docs/specs/red25519-signature-scheme/"
category: "Diseño"
lastUpdated: "2020-08"
accurateFor: "0.9.47"
...
El esquema de firma especificado aquí, Red25519, es una instancia de [RedDSA](https://github.com/zcash/zips/tree/master/protocol/protocol.pdf), un esquema de firma basado en Schnorr que soporta re-aleatorización de claves. Tiene las siguientes funciones:
...
**B** : El punto base Ed25519 como en [RFC-8032](https://tools.ietf.org/html/rfc8032).

**L** : El orden Ed25519 2^252 + 27742317777372353535851937790883648493 como en [RFC-8032](https://tools.ietf.org/html/rfc8032).
...
Para facilitar la implementación, escribimos explícitamente a continuación las funciones RedDSA (así como varias funciones auxiliares) ya especializadas para Red25519. Los implementadores deben consultar la sección 5.4.6 de [RedDSA](https://github.com/zcash/zips/tree/master/protocol/protocol.pdf) para la especificación general de las funciones RedDSA.
...
```
Ten en cuenta que la implementación de `CONVERT_ED25519_PRIVATE` es equivalente al cálculo del escalar secreto s al derivar una clave pública Ed25519 de una clave privada Ed25519, como se especifica en los pasos 1-3 de la sección 5.1.5 de [RFC-8032](https://tools.ietf.org/html/rfc8032).

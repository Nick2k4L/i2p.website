...
Полная спецификация протокола доступна на странице [спецификации I2NP](/docs/specs/i2np/). См. также страницу [спецификации общих структур данных](/docs/specs/common-structures/).

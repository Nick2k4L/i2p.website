...
<th style="border: 1px solid var(--color-border); padding: 8px;">Тип</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Код</th>
</tr>
<tr>
...
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">Тип</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Код типа</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Длина X</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Длина Msg 1</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Длина Msg 1 Enc</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Длина Msg 1 Dec</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Длина PQ ключа</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Длина opt</th>
</tr>
<tr>
...
</table>Примечание: Коды типов предназначены только для внутреннего использования. Router останутся типа 4, а поддержка будет указана в адресах router.
...
<table style="border: 1px solid var(--color-border); border-collapse: collapse;">
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">Максимальный размер заполнения сообщения</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">не-PQ (до 0.9.68)</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">не-PQ (начиная с 0.9.69)</th>
...
</table>## Анализ накладных расходов
...
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">Тип</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Pubkey (Сообщение 1)</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Cipertext (Сообщение 2)</th>
</tr>
<tr>
<td style="border: 1px solid var(--color-border); padding: 8px;">MLKEM512_X25519</td>
<td style="border: 1px solid var(--color-border); padding: 8px;">+816</td>
...
<table style="border: 1px solid var(--color-border); border-collapse: collapse;">
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">Категория</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Уровень безопасности как у</th>
</tr>
<tr>
...
<table style="border: 1px solid var(--color-border); border-collapse: collapse;">
<tr style="background-color: var(--color-bg-secondary);">
<th style="border: 1px solid var(--color-border); padding: 8px;">Алгоритм</th>
<th style="border: 1px solid var(--color-border); padding: 8px;">Категория безопасности</th>
</tr>
<tr>
...
</table>## Примечания по реализации

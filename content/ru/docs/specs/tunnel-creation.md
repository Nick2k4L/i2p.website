...
Эта стратегия возникла во время обсуждения в списке рассылки I2P между Майклом Роджерсом, Мэтью Тоузлендом (toad) и jrandom относительно атаки предшественника. См. [TUNBUILD-SUMMARY](http://zzz.i2p/archive/2005-10/msg00138.html), [TUNBUILD-REASONING](http://zzz.i2p/archive/2005-10/msg00129.html). Она была введена в релизе 0.6.1.10 от 2006-02-16, который стал последним разом, когда в I2P было внесено изменение, несовместимое с предыдущими версиями.

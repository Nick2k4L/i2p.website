...
- [I2P-Bote](http://i2pbote.i2p/) - связаться с HungryHobo
- [Syndie](http://syndie.i2p2.de/)
- [IMule](http://www.imule.i2p/)
- [I2Phex](http://forum.i2p/viewforum.php?f=25)

См. также все плагины на [plugins.i2p](http://plugins.i2p/), приложения и исходный код, перечисленные на [echelon.i2p](http://echelon.i2p/), а также код приложений, размещенный на [git.repo.i2p](http://git.repo.i2p/).

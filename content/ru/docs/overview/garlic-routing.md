...
Tunnel строятся и затем используются с многослойным шифрованием. Это описано на [странице реализации tunnel](/docs/specs/implementation/). Мы используем [ElGamal/AES+SessionTag](/docs/specs/elgamal-aes/) для шифрования.

...
- [Javadoc для Lease](http://idk.i2p/javadoc-i2p/net/i2p/data/Lease.html)
- [Javadoc для LeaseSet](http://idk.i2p/javadoc-i2p/net/i2p/data/LeaseSet.html)

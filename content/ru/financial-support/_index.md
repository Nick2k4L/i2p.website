...
/* ── Двухколоночная компоновка с содержанием ── */   .support-layout {
...
/* ── Анимированный Hero ── */   .support-hero {
...
/* ── Стили секции с чередующимися фонами ── */   .support-section {
...
/* ── Список с галочками ── */   .support-list {
...
/* ── Карточки криптовалютных пожертвований ── */   .donation-methods {
...
/* ── Карточки уровней спонсорства ── */   .tier-grid {
...
/* ── Информационная панель ── */   .info-box {
...
/* ── Ссылки карточки CTA ── */   .support-card .card-cta {

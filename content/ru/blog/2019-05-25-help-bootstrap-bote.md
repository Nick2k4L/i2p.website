...
I2P-Bote — это плагин для I2P, и его установка очень проста. Оригинальные инструкции доступны на eepSite bote, bote.i2p, но если вы хотите прочитать их в clearnet (обычном интернете), эти инструкции любезно предоставлены bote.i2p:

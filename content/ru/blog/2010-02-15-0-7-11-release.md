...
Релиз 0.7.11 исправляет несколько проблем, в том числе связанные с системным временем, которые мешали новым routers быстро интегрироваться в сеть. Он также исправляет установщик для 64-битной Windows. Релиз включает обновление до Jetty 5.1.15 для устранения [этой уязвимости](http://www.kb.cert.org/vuls/id/402580).

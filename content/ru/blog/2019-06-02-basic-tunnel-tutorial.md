...
Перейдите в веб-интерфейс I2P по адресу 127.0.0.1:7657 и откройте `http://127.0.0.1:7657/i2ptunnelmgr` (ссылка ведет на localhost). Нажмите кнопку «Tunnel Wizard», чтобы начать.

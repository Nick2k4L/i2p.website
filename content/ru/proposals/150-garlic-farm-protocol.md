...
JRaft — это реализация протокола Raft [RAFT](/docs/research/ongaro2014-raft.pdf).
...
Содержимое приложения кодируется в UTF-8 [JSON](https://www.json.org/json-en.html).

...
```
ПРИМЕЧАНИЕ: RI может быть отправлен либо как сообщения I2NP Database Store в блоках I2NP, либо в виде блоков RI (если они достаточно малы). Они могут находиться в тех же пакетах, что и релейные блоки, если размер позволяет.

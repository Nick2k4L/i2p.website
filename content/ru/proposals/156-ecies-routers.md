...
- Создание туннелей реализовано в 0.9.48, см. [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
Для использования ECIES вместо ElGamal требуется несколько изменений спецификации создания туннелей [Tunnel-Creation](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
Шифрование запросов соответствует тому, что указано в [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) и [Prop152](/proposals/152-ecies-tunnels/),
...
Это соответствует тому, что указано в [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) и [Prop152](/proposals/152-ecies-tunnels/) для сообщений о создании туннелей.

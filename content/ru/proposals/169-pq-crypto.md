...
Для Алисы, после шифрования сообщения с помощью Noise, но до AES-маскировки X, установите X[31] |= 0x80.
...
```
  ...
  +----+----+----+----+----+----+----+----+
```
Примечание: поле версии в блоке параметров сообщения 1 должно быть установлено в значение 2, даже для PQ-соединений.

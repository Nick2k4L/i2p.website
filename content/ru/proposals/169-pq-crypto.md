...
Максимальный размер: используйте MTU от Bob, как указано в его RouterInfo, или значение по умолчанию 1500, если MTU не указано в RouterInfo. Не используйте MLKEM768_X25519, если опубликованный MTU слишком мал.

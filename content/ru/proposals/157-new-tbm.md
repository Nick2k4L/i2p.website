...
См. [I2NP](/docs/specs/i2np/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) для окончательной спецификации.
...
Изменения в формате записи размером 528 байт для маршрутизаторов ECIES-X25519 специфицированы в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
- Поддержание достаточного места для будущих опций, как в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
- Вписывание в одно туннельное сообщение для обратного пути
- Поддержка только узлов ECIES
- Поддержание улучшений, реализованных в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
...
и записями ECIES, определенными в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies), которые занимают 464 байта.

Записи нешифрованного ответа будут занимать 202 байта,
по сравнению с записями ElGamal, которые занимают 496 байт,
и записями ECIES, определенными в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies), которые занимают 512 байт.
...
Шифрование записей запроса и ответа: как определено в [Prop152](/proposals/152-ecies-tunnels/) и [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies).
...
Обзор изменений из [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies):
...
Поле флагов такое же как определено в [Tunnel-Creation](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) и содержит следующее:
...
как определено в [Tunnel-Creation](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) для предотвращения фингерпринтинга:

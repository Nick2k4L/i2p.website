...
- **Reseed Tools**: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)의 공식 reseed-tools(네트워크 부트스트랩용 도구)
...
I2P 프로젝트에서 관리하는 공식 구현입니다. 저장소: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)
...
PurpleI2P 프로젝트의 대체 구현: [PurpleI2P/pyseeder](https://github.com/PurpleI2P/pyseeder)
...
**문서**: [Notes on I2P reseed over Cloudflare](https://homepage.np-tokumei.net/post/notes-i2p-reseed-over-cloudflare/)
...
**연구 문서**: [Censorship-resistant reseeding notes](https://homepage.np-tokumei.net/post/notes-censorship-resistant-i2p-reseeding/)
...
[checki2p.com/reseed](https://checki2p.com/reseed) 에 있는 서비스는 모든 등록된 I2P reseed 서버(reseed: 초기 피어 정보를 배포하는 서버)에 대해 4시간마다 자동 점검을 수행합니다. 이는 다음을 제공합니다:
...
- **Reseed 도구 저장소**: [i2pgit.org/idk/reseed-tools](https://i2pgit.org/idk/reseed-tools)
- **Reseed 도구 문서**: [eyedeekay.github.io/reseed-tools](https://eyedeekay.github.io/reseed-tools/)
...
- **Python WSGI reseeder (I2P 네트워크 초기 피어 배포 서버)**: [torbjo/i2p-reseeder](https://github.com/torbjo/i2p-reseeder)

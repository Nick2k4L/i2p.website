...
Tunnel은 계층화된 암호화를 사용하여 구축되고 사용됩니다. 이는 [tunnel 구현 페이지](/docs/specs/tunnel-implementation/)에서 설명됩니다. 암호화를 위해 [ElGamal/AES+SessionTag](/docs/specs/elgamal-aes/)를 사용합니다.

...
앞서 언급했듯이, I2P는 현재(릴리스 0.8) XOR 기반 정렬과 함께 위의 계층화된 랜덤 전략을 포함하고 있습니다. tunnel 운영, 관리 및 피어 선택에 관련된 메커니즘에 대한 더 자세한 논의는 [tunnel spec](/docs/specs/implementation/)에서 찾을 수 있습니다.

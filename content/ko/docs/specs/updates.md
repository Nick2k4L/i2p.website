...
- 0.9.20 릴리스부터 지원되는 개발 빌드의 경우, SU3 버전은 "전체" router 버전입니다. 예: "0.9.20-5" 또는 "0.9.20-5-rc". [I2P 소스](https://github.com/i2p/i2p.i2p)의 RouterVersion.java를 참조하세요.
...
- **[I2P-SRC]** [I2P 소스 코드](https://github.com/i2p/i2p.i2p)

...
변경 사항: 현재의 NTCP2는 단일 ChaCha 섹션 내의 옵션들만 포함하고 있습니다. ML-KEM을 사용하면 옵션 이전에 새로운 ChaCha 섹션이 추가되며, 이 섹션에는 암호화된 양자내성(PQ) 공개 키가 포함됩니다.
...
모든 경우에, 평소와 같이 NTCP2 transport 이름을 사용하십시오.

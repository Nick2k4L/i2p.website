...
**I2P는 인터넷 "내부"에서 실행되는 완전히 암호화된 피어 투 피어 익명 네트워크이며**, geti2p.net에서 제공하는 자바 구현체가 이를 사용하는 주요 방법으로 남아 있습니다. 일반 웹 접근을 익명화하는 데 초점을 둔 Tor와 달리, I2P는 익명 웹사이트(eepsite), 이메일, 채팅, 파일 공유 등으로 구성된 완전히 독립적인 은닉 서비스 네트워크를 만듭니다.

...
1. **I2P 사이트 탐색**: `http://127.0.0.1:7657/home`를 방문하여 인기 있는 I2P 서비스 링크를 확인하세요
2. **브라우저 구성**: `.i2p` 사이트에 접근하기 위해 [브라우저 프로필](/docs/guides/browser-config)을 설정하세요
3. **서비스 탐색**: I2P 이메일, 포럼, 파일 공유 등을 확인해보세요
4. **router 모니터링**: `http://127.0.0.1:7657/console`에서 네트워크 상태와 통계를 확인할 수 있습니다
...
1. `http://127.0.0.1:7657/welcome`로 이동하세요
2. 마법사 단계를 다시 따라하세요

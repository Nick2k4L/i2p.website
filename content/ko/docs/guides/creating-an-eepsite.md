...
1. `http://127.0.0.1:7657`을 엽니다
2. `http://127.0.0.1:7657/i2ptunnelmgr`로 이동합니다
...
1. **`http://127.0.0.1:7657/i2ptunnelmgr`로 돌아가세요**
...
1. **다음 위치로 이동** stats.i2p Add Key (I2P 내에서)
...
1. **다음으로 이동하세요** reg.i2p Add Domain (I2P 내에서)

...
0.7.11 릴리스는 신규 routers가 네트워크에 빠르게 통합되는 것을 막던 여러 문제를 수정합니다. 그중 일부는 클록과 관련되어 있습니다. 또한 64비트 Windows용 설치 프로그램도 수정합니다. 이 릴리스에는 Jetty 5.1.15로의 업데이트가 포함되어 있으며, [이 취약점](http://www.kb.cert.org/vuls/id/402580)을 해결합니다.

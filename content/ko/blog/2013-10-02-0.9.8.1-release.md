...
자세한 내용과 우회 방법은 Trac 티켓을 참조하세요. IPv6 및 기타 변경 사항에 대한 정보는 [0.9.8 릴리스 노트](/blog/2013/09/30/0.9.8-release/)를 참조하세요.

최근 공격으로 인해 Trac에서는 로그인이 비활성화되었고 zzz.i2p에서는 신규 등록이 비활성화되었습니다. 해당 서비스가 복구될 때까지 모든 버그는 IRC freenode 또는 IRC2P #i2p-dev에서 신고해 주세요.

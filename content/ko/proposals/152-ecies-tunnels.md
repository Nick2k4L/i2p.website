...
네트워크 배포 및 테스트가 진행 중입니다. 소폭의 수정이 있을 수 있습니다. 공식 명세는 [SPEC](/docs/specs/tunnel-implementation/)을 참조하세요.
...
```
flags 필드는 [Tunnel 생성](/docs/specs/tunnel-implementation/)에 정의된 것과 동일하며 다음을 포함합니다::
...
응답 바이트는 지문 식별(fingerprinting)을 피하기 위해 [Tunnel Creation](/docs/specs/tunnel-implementation/)에 정의된 다음 값 중 하나입니다:
...
ECIES(타원 곡선 통합 암호화 체계) tunnel 생성자는 [Tunnel Creation](/docs/specs/tunnel-implementation/)에 정의된 스킴을 사용하여 각 ElGamal(엘가말) 홉의 공개키로 암호화해야 합니다. ECIES tunnel 생성자는 ECIES 홉에 대한 암호화에 위 스킴을 사용합니다.
...
[Tunnel Creation](/docs/specs/tunnel-implementation/)에 정의된 대로입니다. ElGamal 홉에 대한 암호화에는 변경 사항이 없습니다.
...
* [사양](/docs/specs/tunnel-implementation/#tunnel-creation-ecies)
* [Tunnel 생성](/docs/specs/tunnel-implementation/)

...
- 터널 빌딩은 0.9.48에 구현됨, [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) 참조.
...
요청 암호화는 [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) 및 [Prop152](/proposals/152-ecies-tunnels/)에 지정된 것과 동일하며,
노이즈 "N" 패턴을 사용함.
...
이는 [Tunnel-Creation-ECIES](/docs/specs/tunnel-implementation/#tunnel-creation-ecies) 및 [Prop152](/proposals/152-ecies-tunnels/)에 터널 빌드 메시지에 지정된 것과 동일함.

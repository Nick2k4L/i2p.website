...
| 프로토콜 / 기능 | 상태 |
|--------------------|--------|
| 하이브리드 MLKEM 래칫 및 LS | 승인 2025-06; 베타 2025-08; 출시 2025-11 |
| 하이브리드 MLKEM NTCP2 | 실서버 네트워크에서 테스트 완료, 승인 2026-02; 베타 목표 2026-02; 출시 목표 2026-05 |
| 하이브리드 MLKEM SSU2 | 승인 2026-02; 베타 목표 2026-05; 출시 목표 2026-08 |
| MLDSA 서명 유형 12-14 | 예비 단계, 2027년까지 보류 |
| MLDSA 대상지(Dests) | 예비 단계, 2027년까지 보류, 실서버 네트워크에서 테스트 완료, 플러드필(floodfill) 지원을 위해 네트워크 업그레이드 필요 |
| 하이브리드 서명 유형 15-17 | 예비 단계, 2027년까지 보류 |
| 하이브리드 대상지(Dests) | |
## 설계
...
암호화 도입보다 서명 도입이 1년 이상 더 늦어질 것이며, 이는 하위 호환성이 불가능하기 때문이다.

I2P에서 MLDSA 서명 지원 작업은 표준 기구들이 알고리즘을 선정하고, 키 및/또는 서명 크기를 줄이는 방안을 마련하며, 산업계 채택을 촉진할 때까지 2027년 후반 또는 2028년까지 보류된 상태입니다. [CABFORUM](https://cabforum.org/2024/10/10/2024-10-10-minutes-of-the-code-signing-certificate-working-group/) 및 [PLANTS](https://datatracker.ietf.org/wg/plants/about/)를 참조하세요. 또한 MLDSA의 산업계 채택은 CA/브라우저 포럼과 인증 기관(CA)에 의해 표준화될 예정입니다. CA들은 먼저 하드웨어 보안 모듈(HSM) 지원이 필요하지만, 현재로서는 이러한 지원이 제공되지 않고 있습니다 [CA/Browser Forum](https://cabforum.org/2024/10/10/2024-10-10-minutes-of-the-code-signing-certificate-working-group/). 우리는 CA/브라우저 포럼이 복합 서명(composite signatures) 지원 여부 또는 필수화 여부를 포함한 구체적인 파라미터 선택에 관한 결정을 주도할 것으로 기대하고 있습니다 [IETF draft](https://datatracker.ietf.org/doc/draft-ietf-lamps-pq-composite-sigs/).

| 마일스톤 | 목표 시점 |
|-----------|--------|
| Ratchet 베타 | 2025년 후반 |
| 최적 암호화 방식 선택 | 2025년 후반 |
| NTCP2 베타 | 2026년 초반 |
| SSU2 베타 | 2026년 초반 |
| Ratchet 정식 출시 | 2026년 초반 |
| Ratchet 기본값 설정 | 2026년 초반 |
| 서명 기능 베타 | 2027년 후반? |
| NTCP2 정식 출시 | 2026년 중반 |
| SSU2 정식 출시 | 2026년 중반 |
| 최적 서명 방식 선택 | 2028년? |
| 서명 기능 정식 출시 | 2028년? |
## 마이그레이션

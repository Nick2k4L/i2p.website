...
최대 크기: Bob의 RouterInfo에 공개된 MTU를 사용하거나, RouterInfo에 없으면 기본값 1500을 사용합니다. 공개된 MTU가 너무 낮은 경우 MLKEM768_X25519는 사용하지 마십시오.
...
최대 크기: 앨리스는 아직 밥의 RouterInfo를 가지고 있지 않아서 그가 공개한 MTU를 알 수 없습니다. 이 메시지의 경우, 다음 방식으로 임시 MTU를 사용합니다. MLKEM512_X25519의 경우, 1280 또는 수신된 SessionRequest 크기 중 큰 값을 MTU로 사용합니다. MLKEM768_X25519의 경우, (IPv4 기준 1318 또는 IPv6 기준 1338) 또는 수신된 SessionRequest 크기 중 큰 값을 MTU로 사용합니다. MLKEM 공개키보다 MLKEM 암호문이 더 작기 때문에, SessionCreated의 오버헤드는 SessionRequest의 오버헤드보다 작습니다. 따라서 SessionRequest에서 패딩이 거의 없거나 전혀 없었더라도, SessionCreated에서는 다양한 크기의 패딩을 사용할 수 있습니다.

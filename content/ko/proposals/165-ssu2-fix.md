...
MixHash(Bob의 식별 해시)를 "SessionRequest" 메시지의 NOISE 상태에 추가합니다, 예:  h = SHA256 (h || Bob의 식별 해시). 이것은 ENCRYPT 또는 DECRYPT에 대한 마지막 MixHash로 사용되어야 합니다. 추가적인 SSU2 헤더 플래그 "Verify Bob의 식별" = 0x02가 도입되어야 합니다.

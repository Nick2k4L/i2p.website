...
Todos os binários e pacotes de código-fonte estão em [syndie.de](https://syndie.de/download) e syndie.i2p. Os plugins estão disponíveis em plugins.i2p e stats.i2p.

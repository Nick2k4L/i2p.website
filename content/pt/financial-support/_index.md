...
/* ── Layout de duas colunas com TOC ── */   .support-layout {
...
/* ── Estilo da seção com fundos alternados ── */   .support-section {
...
/* ── Lista de marcas de verificação ── */   .support-list {
...
/* ── Cartões de doação cripto ── */   .donation-methods {
...
/* ── Cartões de nível de patrocínio ── */   .tier-grid {
...
/* ── CTA card links ── */   .support-card .card-cta {
...
/* ── Destaque de funcionalidade ── */   .feature-highlight {

...
Em vez de 32 bytes para RouterIdent, podemos provavelmente usar 4 bytes siphash-do-hash, algum HKDF ou algo mais, que deve ser suficiente.
...
Adicionar MixHash(hash do ident de Bob) ao estado NOISE da mensagem "SessionRequest", por exemplo, h = SHA256(h || hash do ident de Bob). Deve ser o último MixHash usado como ad para ENCRYPT ou DECRYPT. Deve-se introduzir a flag de cabeçalho adicional do SSU2 "Verificar ident de Bob" = 0x02.
